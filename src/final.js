...
if (score !== null) {
  switch (true) {
    case 26-score >= 22:
      message = `Εξαιρετική επίδοση! Έχετε ολοκληρώσει το εκπαιδευτικό μάθημα με σκορ ${26-score} / 26! Συγχαρητήρια!`;
      break;
    case 20-score >= 18:
      message = `Πολύ καλή απόδοση! Ολοκληρώσατε το εκπαιδευτικό μάθημα με σκορ ${26-score} / 26! Συνεχίστε έτσι!`;
      break;
    case 20-score >= 15:
      message = `Καλή απόδοση! Ολοκληρώσατε το εκπαιδευτικό μάθημα με σκορ ${26-score} / 26. Συνεχίστε την προσπάθεια!`;
      break;
    default:
      message = `Χρειάζεται περαιτέρω βελτίωση. Ολοκληρώσατε το εκπαιδευτικό μάθημα με σκορ ${26-score} / 26. Μην το βάζετε κάτω!`;
  }
} else {
